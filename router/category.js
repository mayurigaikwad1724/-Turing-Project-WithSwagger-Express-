...
const{get_category,get_by_category_id, category_product_id,join_category_department}=require("../controller/categories")
const app=express()
...
// for jsoin the category and department id
