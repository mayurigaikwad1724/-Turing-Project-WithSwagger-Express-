...
// join two colums category id and product id
...
const join_category_department=(req,res)=>{
    knex("category").select("category_id","category.name","category.description","department.department_id")
...
module.exports={get_category,get_by_category_id,category_product_id,join_category_department}