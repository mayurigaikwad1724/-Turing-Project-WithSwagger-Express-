...
const attribute_by_id=(req,res)=>{
    ...
    .then((data)=>{
        ...
        res.send({
            error:err,
            data:"some problem are there"
        })
    })
}


// join two column attribute_value and attribute id
...
module.exports={attribute_id,attribute_by_id,join_attribut_attributeValue,attribute_by_product_id}