...
const {JSONCookie}=require("body-parser")
...
module.exports={product,searchProduct,products_by_product_id,product_category_id,product_departmentId,productDetails_byId,getLocations_join_ByproductId,products_post_review}
